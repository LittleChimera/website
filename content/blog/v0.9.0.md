...
The home page itself was rebuilt around that. It leads with what's deploying right now, then what a rule is holding and what each hold waits for, then everything already on its newest build. Beside that, your changes, how the week is going, and the recent activity.
...
Getting there meant a redesign. Every page was rebuilt on the same components as the home page and the rollout pages, it uses the full width of whatever screen it's on, and it finally holds up on a phone.
