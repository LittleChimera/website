...
Getting there meant a redesign, and the home page was rebuilt around it. It leads with what's deploying right now, then what a rule is holding and what each hold waits for, then everything already on its newest build. Beside that, your changes, how the week is going, and the recent activity. Every other page was rebuilt on the same components.
